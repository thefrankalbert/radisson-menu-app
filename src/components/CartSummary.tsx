        ...
        <div className="fixed bottom-24 right-6 z-[100]">
            ...
            >
                <div className="relative">
                    ...
                    <div className="absolute -top-2 -right-2 bg-radisson-gold text-radisson-blue text-[11px] font-black w-6 h-6 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                        {totalItems}
                    </div>
                </div>
            </Link>
