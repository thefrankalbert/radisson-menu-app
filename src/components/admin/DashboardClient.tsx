...
export default function DashboardClient({
    ...
    useEffect(() => {
        ...
        // We don't loadData() initially because it's passed as props
                    ...
                    {popularItems.length > 0 ? (
                        <div className="p-4 space-y-3">
                            {popularItems.map((item, idx) => (
                                ...
                                >
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm ${idx === 0 ? 'bg-amber-100 text-amber-700' :
