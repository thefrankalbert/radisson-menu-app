  ...
  return (
    <html lang="fr" className="scroll-smooth">
      <body className={`${publicSans.variable} ${montserrat.variable} ${playfair.variable} font-sans bg-background antialiased text-foreground`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[200] focus:bg-white focus:px-4 focus:py-2 focus:rounded-lg focus:shadow-lg focus:text-[#002C5F] focus:font-bold"
        >
